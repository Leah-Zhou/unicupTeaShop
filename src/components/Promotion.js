...
const Promotion = (props, ref) => {
  ...
  const parentObserver =new IntersectionObserver(([entry])=>{
  ...
  return ( 
    ...
    <div className="wrap">
    <section style={{display:"flex", flexFlow:"column wrap", overflow:"hidden"}} ref={observeRef} >
      <motion.img src={imgTop} alt="promotion" className="img-size" variants={imgVariants} custom={-50} initial="initial" animate={inView?"animate":"initial"} />
      <motion.img src={imgBottom} alt="promotion" className="img-size" variants={imgVariants} custom={50} initial="initial" animate={inView?"animate":"initial"} />
      </section>
      <motion.div className="promote-info" variants={contentVariants} initial="initial" animate={inView?"animate":"initial"}>
       <h2>NEW RELEASE!</h2>
